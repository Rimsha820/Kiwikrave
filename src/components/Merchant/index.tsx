    ...
    <div id="merchant" className="merchant">
      ...
      <section className="merchant-section merchant-testimonial">
        <div className="container testimonial-grid">
          <div className="quote">
            <p><i className="fa-solid fa-quote-left"></i> {TESTIMONIALS[quoteIndex].text}</p>
            <div className="author">{TESTIMONIALS[quoteIndex].author}</div>
          ...
          <div className="photo" aria-hidden="true">
            {TESTIMONIALS.map((it, i) => (
              <div key={i} className={`qimg${i === quoteIndex ? ' is-active' : ''}`} style={{ backgroundImage: `url(${it.img})` }} />
            ))}
          </div>
        </div>
      </section>
